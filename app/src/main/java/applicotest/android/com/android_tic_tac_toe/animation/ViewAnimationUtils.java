...
public class ViewAnimationUtils {
     ...
     * Views clipped by a circular reveal applicotest.android.com.android_tic_tac_toe.animation take priority over
     * {@link android.view.View#setClipToOutline(boolean) View Outline clipping}.
     * <p>
     * Note that the applicotest.android.com.android_tic_tac_toe.animation returned here is a one-shot applicotest.android.com.android_tic_tac_toe.animation. It cannot
     ...
     * Lifting view
     *
     * @param view The applicotest.android.com.android_tic_tac_toe.animation target
     * @param baseRotation initial Rotation X in 3D space
     * @param fromY initial Y position of view
     * @param duration aniamtion duration
     * @param startDelay start delay before applicotest.android.com.android_tic_tac_toe.animation begin
     */
